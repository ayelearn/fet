The following text has been accessed from https://en.wikipedia.org/wiki/Glycolysis at Fri Aug 9 01:42:37 IST 2019
...
In most organisms, glycolysis occurs in the cytosol. The most common type of
...
one compound as a glycolysis intermediate: fructose 1,6-bisphosphate.[15]
...
phosphates[2] (G3P).
   D-Glucose (Glc)            Hexokinase (HK)     Î±-D-Glucose-6-phosphate
                               a transferase                (G6P)
                                         
                     ATP            H+ + ADP           [Alpha-D-glucose-6-
[D-glucose_wpmp.svg]   [Biochem_reaction_arrow         phosphate_wpmp.svg]
                     forward_YYNN_horiz_med.svg]
                                         
 
The first step in glycolysis is phosphorylation of glucose by a family of
enzymes called hexokinases to form glucose_6-phosphate (G6P). This reaction
...
Cofactors: Mg2+
===============================================================================
 Î±-D-Glucose_6-phosphate     Phosphoglucose     Î²-D-Fructose_6-phosphate
           (G6P)                isomerase (PGI)              (F6P)
                                 an isomerase
                                           
      [Alpha-D-glucose-6-     [Biochem_reaction   [Beta-D-fructose-6-phosphate
      phosphate_wpmp.svg]   arrow_reversible_NNNN          wpmp.png]
                               horiz_med.svg]
                                           
 
G6P is then rearranged into fructose_6-phosphate (F6P) by glucose_phosphate
isomerase. Fructose can also enter the glycolytic pathway by phosphorylation at
this point.
The change in structure is an isomerization, in which the G6P has been
converted to F6P. The reaction requires an enzyme, phosphoglucose isomerase, to
proceed. This reaction is freely reversible under normal cell conditions.
However, it is often driven forward because of a low concentration of F6P,
which is constantly consumed during the next step of glycolysis. Under
conditions of high F6P concentration, this reaction readily runs in reverse.
This phenomenon can be explained through Le_Chatelier's_Principle.
Isomerization to a keto sugar is necessary for carbanion stabilization in the
fourth reaction step (below).
===============================================================================
 Î²-D-Fructose_6-phosphate phosphofructokinase   Î²-D-Fructose_1,6-bisphosphate
           (F6P)                   (PFK-1)                    (F1,6BP)
                                a transferase
                                           
                             ATP       H+ + ADP
[Beta-D-fructose-6-phosphate  [Biochem_reaction   [Beta-D-fructose-1,6-bisphosphate
         wpmp.png]            arrow_forward_YYNN              wpmp.svg]
                                horiz_med.svg]
                                           
 
The energy expenditure of another ATP in this step is justified in 2 ways: The
glycolytic process (up to this step) becomes irreversible, and the energy
supplied destabilizes the molecule. Because the reaction catalyzed by
Phosphofructokinase_1 (PFK-1) is coupled to the hydrolysis of ATP (an
energetically favorable step) it is, in essence, irreversible, and a different
pathway must be used to do the reverse conversion during gluconeogenesis. This
makes the reaction a key regulatory point (see below). This is also the rate-
limiting step.
Furthermore, the second phosphorylation event is necessary to allow the
formation of two charged groups (rather than only one) in the subsequent step
of glycolysis, ensuring the prevention of free diffusion of substrates out of
the cell.
The same reaction can also be catalyzed by pyrophosphate-dependent
phosphofructokinase (PFP or PPi-PFK), which is found in most plants, some
bacteria, archea, and protists, but not in animals. This enzyme uses
pyrophosphate (PPi) as a phosphate donor instead of ATP. It is a reversible
...
(HPO42â),[7] which dissociates to contribute the extra H+ ion and gives a net
charge of -3 on both sides.
Here, Arsenate (AsO43â), an anion akin to inorganic phosphate may replace
phosphate as a substrate to form 1-arseno-3-phosphoglycerate. This, however, is
unstable and readily hydrolyzes to form 3-phosphoglycerate, the intermediate in
the next step of the pathway. As a consequence of bypassing this step, the
molecule of ATP generated from 1-3_bisphosphoglycerate in the next reaction
will not be made, even though the reaction proceeds. As a result, arsenate is
an uncoupler of glycolysis.[21]
===============================================================================
1,3-bisphosphoglycerate  phosphoglycerate_kinase (PGK) 3-phosphoglycerate (3PG)
        (1,3BPG)                 a transferase
                                              
                         ADP                 ATP
    [1,3-bisphospho-D-       [Biochem_reaction_arrow    [3-phospho-D-glycerate
      glycerate.png]          reversible_YYYY_horiz           wpmp.png]
                                    med.svg]
                                              
                                              
                        phosphoglycerate_kinase (PGK)
...
phosphoglycerate. At this step, glycolysis has reached the break-even point: 2
molecules of ATP were consumed, and 2 new molecules have now been synthesized.
This step, one of the two substrate-level_phosphorylation steps, requires ADP;
thus, when the cell has plenty of ATP (and little ADP), this reaction does not
occur. Because ATP decays relatively quickly when it is not metabolized, this
is an important regulatory point in the glycolytic pathway.
ADP actually exists as ADPMgâ, and ATP as ATPMg2â, balancing the charges at
-5 both sides.
Cofactors: Mg2+
===============================================================================
3-phosphoglycerate (3PG) phosphoglycerate_mutase (PGM) 2-phosphoglycerate (2PG)
                                   a mutase
                                              
 [3-phospho-D-glycerate      [Biochem_reaction_arrow    [2-phospho-D-glycerate
       wpmp.png]              reversible_NNNN_horiz           wpmp.png]
                                    med.svg]
                                              
 
Phosphoglycerate_mutase isomerises 3-phosphoglycerate into 2-phosphoglycerate.
===============================================================================
2-phosphoglycerate (2PG)        enolase (ENO)    phosphoenolpyruvate (PEP)
                                   a lyase
                                          
                                        H2O
 [2-phospho-D-glycerate  [Biochem_reaction_arrow    [Phosphoenolpyruvate
       wpmp.png]          reversible_NYYN_horiz           wpmp.png]
                                med.svg]
                                          
                                          
                               enolase (ENO)
...
favourable.
Using the measured concentrations of each step, and the standard free energy
...
the dominant manner by which these pathways are controlled in the liver, fat,
...
concentrations in cells are much higher than those of AMP, typically 100-fold
...
seconds to 2 minutes during a maximal effort in humans. (At lower exercise
...
in air as the final electron acceptor.
    ...
    * The intra-mitochondrial NADH + H+ is oxidized to NAD+ by the electron
      transport_chain, using oxygen as the final electron acceptor to form
...
capillary support often results in hypoxia (decreased O2 supply) within the
...
***** References[edit] *****
  ...
  29. ^Beis, I.; Newsholme, E. A. (1975). "The_contents_of_adenine_nucleotides,
      phosphagens_and_some_glycolytic_intermediates_in_resting_muscles_from
...
***** External links[edit] *****
    ...
    * Glycolytic_cycle_with_animations at wdv.com
