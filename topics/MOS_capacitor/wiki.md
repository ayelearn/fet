The following text has been accessed from https://en.wikipedia.org/wiki/MOSFET#Metal–oxide–semiconductor_structure at Fri Aug 9 03:39:14 IST 2019
...
practical.[11] The FET concept was later also theorized by Oskar_Heil in the
...
information_age.[17][18] The MOS transistor is the basic building block of the
...
transistor, was first demonstrated in 1988, by a Toshiba research team
...
***** References[edit] *****
 ...
 124. ^Lindsay, R.; Pawlak; Kittl; Henson; Torregiani; Giangrandi; Surdeanu;
      ...
      D7.4.
 125. ^"VLSI_wiring_capacitance" (PDF). IBM Journal of Research and
      Development.
 126. [dead_link]
 127. ^Soudris, D.; Pirsch, P.; Barke, E., eds. (2000). Integrated_Circuit
      Design:_Power_and_Timing_Modeling,_Optimization,_and_Simulation_(10th
      Int._Workshop). Springer. p. 38. ISBN 978-3-540-41068-3.
 128. ^Orshansky, Michael; Nassif, Sani; Boning, Duane (2007). Design_for
...
index.php?title=MOSFET&oldid=909975556"
Categories:
    * Transistor_types
    * MOSFETs
Hidden categories:
...
**** Languages ****
    ...
    * ä¸­æ
Edit_links
    * This page was last edited on 8 August 2019, at 21:09 (UTC).
